...
public final class MapLocale {
  ...
  @StringDef( {LOCAL_NAME, ARABIC, CHINESE, SIMPLIFIED_CHINESE, TRADITIONAL_CHINESE, ENGLISH,
          FRENCH, GERMAN, JAPANESE, KOREAN, PORTUGUESE, RUSSIAN, SPANISH, VIETNAMESE})
  ...
  /**
   * USA bounding box excluding Hawaii and Alaska extracted from OpenStreetMap
   */
  ...
  /**
   * UK bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Canada bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * China bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Taiwan bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Germany bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Korea bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Japan bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * France bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Russian bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Spain bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Portugal bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Brazil bounding box extracted from OpenStreetMap
   */
  ...
  /**
   * Vietnam bounding box extracted from OpenStreetMap
   */
